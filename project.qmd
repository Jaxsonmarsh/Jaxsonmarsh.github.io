...
This ggplot shows the effect of someone's sleep duration ('Sleep.Duration') and level of physical activity ('Physical.Activity.Level') on their stress levels ('Stress.Level') :angry: :happy: .
